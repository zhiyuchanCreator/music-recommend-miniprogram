...
mock_albums = [
    ...
    {"title": "Homogenic", "artist": "Bjork", "year": 1997, "genre": ["electronic", "art pop"], "rating": 69, "description": "Icelandic electronic perfection"},
...
def generate_albums(limit=50):
    print(f'生成 {limit} 张专辑数据...')
